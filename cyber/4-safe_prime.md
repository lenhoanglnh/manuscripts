...
Comment pourriez-vous calculer rapidement g^1'050'625^ modulo p ?
...
Cela nous donne 1'050'625 = 2^20^ + 2^12^ + 2^0^.
...
Maintenant, pour calculer g^2²⁰^, on va calculer la suite des carrés
g, g², (g²)², ((g²)²)², et ainsi de suite jusqu'à la combinaison de 20 opérations.
De manière cruciale, pour arriver jusqu'à 2^20^,
il suffit en fait de prendre 20 fois des carrés.
C'est beaucoup mieux que 1'050'625 de fois !
De même on peut aisément calculer g puissance 2^12^.
...
En divisant par g des deux côtés, on conclut que g^p-1^ =_p_ 1.
Or on peut aussi écrire 1 =_p_ g^0^.
Donc g^p-1^ =_p_ g^0^.
...
Enfin, le groupe engendré par g_5_ =_p_ g^2\*3^ va osciller entre 5 valeurs,
à savoir 1, g_5_, g_5_², g_5_³ et g_5_⁴.
...
> Techniquement la complexity sera O(\sum_q_ k_q_ (log(n) + sqrt(q)), 
> si p-1 = \prod q^k_q_^.
...
De même, on peut s'intéresser aux suites telles p_1_ est premier,
p_2_ = 2 p_1_ + 1 est premier,
p_3_ = 2 p_2_ + 1 est premier, et ainsi de suite.
