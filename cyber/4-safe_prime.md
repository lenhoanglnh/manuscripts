...
Résoudre le problème x, c'est alors trouver un nombre v tel que x = g<sup>v</sup>.
...
à l'équation x = g<sup>v</sup>.

Pour ceux qui ont vu 
la chouette [vidéo](https://tournesol.app/entities/yt:1Yv8m398Fv0) de Science Étonnante,
cette astuce qui consiste à cacher w et à révéler x = g<sup>w</sup> est au coeur
...
et si x = g<sup>w</sup> est calculé modulo un nombre premier p,
...
Autrement dit, calculer le problème x = g<sup>w</sup> à partir de g et w, c'est facile.
